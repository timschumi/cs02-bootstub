...
bootstub.elf: bootstub.c bootstub.ld entry.c
	$(CROSS_COMPILE)gcc $(CFLAGS) -std=gnu99 -ffreestanding -nostartfiles -nostdlib -Wl,-T,bootstub.ld -o bootstub.elf bootstub.c entry.c
